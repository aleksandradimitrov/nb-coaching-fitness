...
export const exampleBlogData = [
    {
      title: "Най-доброто от Feature тренировките, подбрани за вас",
    ...
    {
      title: "Най-доброто от Feature тренировките, подбрани за вас",
      date: "21 Октомври 2024",
      readTime: "4 мин. четене",
      tags: ["Диета", "Хранителен режим"],
      image: '/assets/blog/image-3.png'
    },
    {
      title: "Най-доброто от Feature тренировките, подбрани за вас",
      date: "18 Октомври 2024",
      readTime: "7 мин. четене",
      tags: [],
      image: '/assets/blog/image-4.png'
    },
    {
      title: "Най-доброто от Feature тренировките, подбрани за вас",
      ...
      readTime: "4 мин. четене",
      tags: [],
      image: '/assets/blog/image-5.png'
    },
    {
      title: "Най-доброто от Feature тренировките, подбрани за вас",
      date: "12 Октомври 2024",
      readTime: "5 мин. четене",
      tags: ["Хранителни добавки"],
      image: '/assets/blog/image-6.png'
    },
    {
      title: "Най-доброто от Feature тренировките, подбрани за вас",
      date: "12 Октомври 2024",
    ...
    },
    {
      ...
      readTime: "5 мин. четене",
      tags: [],
      image: '/assets/blog/image-9.png'
    },
];
  

export const tagColors = {
    "Диета": "bg-green-200 text-green-800",
    "Хранителен режим": "bg-blue-200 text-blue-800",
    "Хранителни добавки": "bg-yellow-200 text-yellow-800",
  };
